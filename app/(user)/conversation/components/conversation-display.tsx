      ...
      <div className="space-y-4 pb-4">
        ...
        {isListening && recognizedText && !isLastMessageFromUser && (
          <motion.div
            ...
            transition={{ duration: 0.3 }}
          >
            <div className="bg-primary/70 ml-auto w-fit max-w-[90%] rounded-lg px-4 py-3 text-sm text-white">
              <motion.div
                animate={{
                  opacity: [0.7, 1, 0.7],
                }}
        ...
        {isListening && !recognizedText && (
          <div className="flex justify-end">
            <div className="from-primary/10 to-background rounded-lg bg-gradient-to-t px-4 py-2 text-sm">
              Đang nghe...
            </div>
          </div>
        )}

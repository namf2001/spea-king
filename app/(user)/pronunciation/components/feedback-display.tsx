  ...
  return (
    <TooltipProvider>
      <motion.div
        ...
        className="mb-10"
      >
        <Card className="from-primary/10 via-primary/5 to-background bg-gradient-to-b pt-0 shadow-lg">
                    ...
                    <div className="flex flex-wrap gap-1">
                      {problemPhonemes.map((phoneme: any, i: number) => (
                        <motion.div
                          ...
                          variants={itemVariants}
                          className={`flex items-center gap-1 rounded-lg border-2 p-1 ${getScoreBgColor(phoneme.accuracyScore)}`}
                          whileHover={{ scale: 1.05 }}
                        >
                          <div

    ...
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="sm:max-w-[425px]">
        <DialogHeader>
          ...
          <DialogDescription>
            Bạn có chắc chắn muốn xóa bài tập từ vựng{' '}
            <span className="font-medium">"{exerciseTitle}"</span>? Hành động
            này không thể hoàn tác và tất cả dữ liệu liên quan sẽ bị xóa vĩnh
            viễn.
          </DialogDescription>
        </DialogHeader>

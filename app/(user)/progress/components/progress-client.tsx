...
export default function ProgressClient({ stats, error }: ProgressClientProps) {
            ...
            <div className="container mx-auto px-4 py-12">
                <div className="max-w-6xl mx-auto">
                    <div className="text-center py-20">
                        ...
                        <p className="text-gray-600 dark:text-gray-300">{error || "Failed to load statistics"}</p>
    ...
    const getProgressPercentage = (count: number) => {
        const maxForLevel = count >= 100 ? 200 : count >= 50 ? 100 : count >= 20 ? 50 : 20
            ...
            <div className="max-w-6xl mx-auto">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                    <Card>
                        ...
                        <CardContent>
                            <div className="text-3xl font-bold text-center mb-2">{stats.totalSpeakingCount}</div>
                            <Progress value={getProgressPercentage(stats.totalSpeakingCount)} className="h-2" />
                            <p className="text-xs text-center mt-2 text-gray-500">{getOverallLevel(stats.totalSpeakingCount)} Level</p>
                        </CardContent>
                    </Card>
                    ...
                    <Card>
                        ...
                        <CardContent className="text-center">
                            <div className="text-3xl font-bold mb-1">{stats.practiceStreak} days</div>
                    ...
                    <Card>
                        <CardHeader className="pb-2">
                            ...
                            <CardDescription>Total practice sessions this month</CardDescription>
                        </CardHeader>
                        <CardContent className="text-center">
                            <div className="text-3xl font-bold mb-1">{stats.exercisesThisMonth}</div>
                            <p className="text-xs text-gray-500">
                                {stats.pronunciationCount} pronunciation, {stats.conversationCount} conversation, {stats.reflexCount} reflex
                            </p>
                        </CardContent>
                    </Card>
                </div>
                    ...
                    <TabsContent value="progress">
                        <Card>
                            <CardHeader>
                                ...
                                <CardDescription>Your daily speaking practice count</CardDescription>
                            </CardHeader>
                            <CardContent>
                                <div className="h-[300px]">
                                    <ResponsiveContainer width="100%" height="100%">
                                        <LineChart data={stats.progressOverTime} margin={{ top: 5, right: 30, left: 20, bottom: 5 }}>
                    ...
                    <TabsContent value="skills">
                        <Card>
                            <CardHeader>
                                ...
                                <CardDescription>Your practice sessions by category</CardDescription>
                            </CardHeader>
                            <CardContent>
                                <div className="h-[300px]">
                                    <ResponsiveContainer width="100%" height="100%">
                                        <BarChart data={stats.skillsBreakdown} margin={{ top: 5, right: 30, left: 20, bottom: 5 }}>
                                            <CartesianGrid strokeDasharray="3 3" />
                                            <XAxis dataKey="name" />
                                            <YAxis domain={[0, 'dataMax + 1']} />
                                            <Tooltip />
                    ...
                    <TabsContent value="recent">
                        <Card>
                            <CardHeader>
                                ...
                                <CardDescription>Your latest speaking practice sessions</CardDescription>
                            </CardHeader>
                            <CardContent>
                                <div className="space-y-4">
                                    {stats.recentRecords.length > 0 ? (
                                                ...
                                                <div className="flex justify-between items-start mb-2">
                                                    <div>
                                                        ...
                                                        <p className="text-sm text-gray-500">
                                                            {record.topicTitle || record.questionText || "Practice session"}
                                                        </p>
                                                    </div>
                                        ...
                                        <div className="text-center py-8">
                                            <p className="text-gray-500">No practice sessions yet. Start practicing to see your progress!</p>
                                        </div>
                                    )}
                                </div>
                            </CardContent>

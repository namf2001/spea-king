  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-xl text-sm font-bold transition-all disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 shrink-0 [&_svg]:shrink-0 outline-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive transform active:scale-95",
  {
    variants: {
      variant: {
        ...
        blue: 'bg-blue-500 text-white shadow-lg shadow-blue-500/60 border-b-4 border-blue-600 hover:bg-blue-600 hover:shadow-xl hover:shadow-blue-600/70 active:border-b-2 active:translate-y-0.5',
        yellow:
        ...
        pink: 'bg-pink-500 text-white shadow-lg shadow-pink-500/60 border-b-4 border-pink-600 hover:bg-pink-600 hover:shadow-xl hover:shadow-pink-600/70 active:border-b-2 active:translate-y-0.5',
        indigo:
        ...
        teal: 'bg-teal-500 text-white shadow-lg shadow-teal-500/60 border-b-4 border-teal-600 hover:bg-teal-600 hover:shadow-xl hover:shadow-teal-600/70 active:border-b-2 active:translate-y-0.5',
        emerald:
        ...
        sky: 'bg-sky-500 text-white shadow-lg shadow-sky-500/60 border-b-4 border-sky-600 hover:bg-sky-600 hover:shadow-xl hover:shadow-sky-600/70 active:border-b-2 active:translate-y-0.5',
        rose: 'bg-rose-500 text-white shadow-lg shadow-rose-500/60 border-b-4 border-rose-600 hover:bg-rose-600 hover:shadow-xl hover:shadow-rose-600/70 active:border-b-2 active:translate-y-0.5',
        lime: 'bg-lime-500 text-white shadow-lg shadow-lime-500/60 border-b-4 border-lime-600 hover:bg-lime-600 hover:shadow-xl hover:shadow-lime-600/70 active:border-b-2 active:translate-y-0.5',
      },
      size: {
